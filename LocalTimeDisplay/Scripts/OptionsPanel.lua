plugin.GetOptionsPanel = function(self)
	...
	localTimeSettingsTitle:SetBackground(Turbine.UI.Graphic("LocalTimeDisplay/Assets/Images/optionsTitleBackground.tga"));
	...
	serverTimeSettingsTitle:SetBackground(Turbine.UI.Graphic("LocalTimeDisplay/Assets/Images/optionsTitleBackground.tga"));
